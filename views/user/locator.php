...
<header>
 ...
 <div class="beijing" style="font-family: 'Satisfy', cursive; font-size: 110px;">
 	Store Locator
 </div>
 <br>
 <hr><br><br>
	<b><center style="font-family: 'Satisfy', cursive; font-size: 43px; float: center;">We look forward to meet you...</center></b>
<br><br><hr><br><br>
...
<div class="row">
  ...
  <div class="col-md-8">
    <img src='../assets/images/2018.JPG' height="400px" width="533px"><br>
    <b><div style="font-family: 'Satisfy', cursive; font-size: 32px;"><br>Sikandrabad Branch<br>Store Address: Hanuman Chowk, Bara Bazar,<br>Sikandrabad 203205<br>Mobile no: 9897902142,9045834344</div></b>
  </div>
  <!--
  <div class="col-md-5">
    <img src='../assets/images/ash3.jpg' height="265px" width="400px"><br>
    <b><div style="font-family: 'Satisfy', cursive; font-size: 27px; float: center;"><br>Store B<br>Store Address: dvskvbjkebvj vbekjbnvkjbekjdvb bnkjdvbjsndv dnvkjsdvndjk</div></b>
  </div>
-->
...
<br><br>
 <hr><br><br>
  <b><center style="font-family: 'Satisfy', cursive; font-size: 35px; float: center;">We gladly look forward you as our favorites!<br>Make us your favorites!</center></b>
<br><br><hr><br><br>
	<footer>
