...
<body>
	...
	<div id="content">
	  ...
	  <?php foreach($namkeens as $namkeen): ?>
	  <div class="detroit">
	    <div class="flipper">
	      <div class="front">
	        <img class="chicago"  src="<?php echo base_url(); ?>assets/images/namkeens/<?php echo $namkeen['namkeen_image']; ?>" alt="cherry blossoms" height=187px width=250px>
	        <b><p class="captain"><div style="font-family: 'Satisfy', cursive; font-size: 32;padding-top: 2px;"><?php echo($namkeen['namkeen_name']); ?></div></p></b>
	      </div>
	      <div class="back">
	        <a class="alan" href="https://en.wikipedia.org/wiki/Cherry_blossom" target="_blank">
	          <div style="font-family: 'Satisfy', cursive; font-size: 32;padding-top: 4px;"><br><?php echo($namkeen['namkeen_name']); ?></div>
	        </a>
	        <p class="description"><?php echo($namkeen['namkeen_description']); ?></p>
	        <p class="date"><div style="font-family: 'Satisfy', cursive; font-size: 38;padding-top: 2px;"><?php echo($namkeen['price']); ?><br><br><?php echo($namkeen['weight']); ?></div></p>
	      </div>
	    </div>
	  </div>
	  <?php endforeach; ?>
