...
<div class="row">
  ...
  <div class="col-md-5">
    <img src='../assets/images/weddingbox1.jpg' height="265px" width="400px"><br>
    <b><div style="font-family: 'Satisfy', cursive; font-size: 27px; float: center;"><br>Store A<br>Store Address: dvskvbjkebvj vbekjbnvkjbekjdvb bnkjdvbjsndv dnvkjsdvndjk</div></b>
  </div>
    ...
    <div class="content" style="color:#000000;">
      ...
      <div id="helpfullinks">
        <div>
          ...
          <ul>
            <li><a href="<?php echo base_url('user/wedding_boxes') ?>" style="color:#000000;font-family: 'Satisfy', cursive; font-size: 20;">Our Wedding Boxes</a></li>
