...
<head>
    ...
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" />
	  <link rel="stylesheet" type="text/css" href="../assets/ncss/linda.css">
...
<header>
 ...
 <div class="manchu" style="font-family: 'Satisfy', cursive;">
 	Our Legacy
 </div>
 <br>
 <hr><br><br>
	<b><center style="font-family: 'Satisfy', cursive; font-size: 50px; float: center;">The road from our history</center></b>
<br><br><hr><br><br>
<div class="prague">
	<div class="row">
		<div class="col-md-6">
			<img src="../assets/images/1981.jpg" height=600px width=666px style="padding-left: 8px; padding-top: 10px; opacity: 1;">
		</div>
		<div class="col-md-6">
			<br><br>
			<p style="font-size: 30; font-family: 'Satisfy', cursive;">
			...
			<p style="font-size: 30; font-family: 'Satisfy', cursive;">
				Authentic taste, finest raw materials and an attitude of never compromising on quality that has earned us the reputation we have today. It is our aim to deliver exceptional tradition sweets and snacks, but at the same time continue to explore and invent new varieties for our customers.
			</p><br>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-10">
			<p style="font-size: 30; font-family: 'Satisfy', cursive;">
				We now have a branch in Dadri, have expanded our ancestral shop in Sikandrabad, and look forward to branch out in other districts of Uttar Pradesh and beyond . We have also ventured into delivering custom made assortment of sweets and snacks boxes for various events like weddings, birthday etc.
			</p><br>
			<p style="font-size: 30; font-family: 'Satisfy', cursive;">
				That small seed of shop that was planted by our ancestors has today grown into a sapling, if not a tree, because we believe we have still ways and miles to go.
			</p>
		</div>
		<div class="col-md-1"></div>
	</div>
